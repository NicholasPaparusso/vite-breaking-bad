...
<template>
    ...
    <div class="smoke-wrap">
      <img class="smoke" src="../assets/img/smoke.png" alt="smoke">
    </div>
    <div class="smoke-wrap">
      <img class="smoke2" src="../assets/img/smoke.png" alt="smoke">
    </div>
    <div class="smoke-wrap">
      <img class="smoke3" src="../assets/img/smoke.png" alt="smoke">
    </div>
